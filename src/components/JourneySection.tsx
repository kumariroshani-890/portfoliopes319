...
const runnerUpHighlights = [
  {
    image: "/achievements/runner-up-1.jpg",
    link: "https://drive.google.com/file/d/1uEk7s9SqEgXseKfzVEaF0wDv3c24o2Z-/view?usp=sharing",
    alt: "2nd Runner-Up Coding Quiz award ceremony image 1",
  },
  {
    image: "/achievements/runner-up-2.jpg",
    link: "https://drive.google.com/file/d/1YXaygv0BacHJcd8ohXfI7QCm19oyhnGJ/view?usp=sharing",
    alt: "2nd Runner-Up Coding Quiz award ceremony image 2",
  },
];
          ...
          <div className="bg-card rounded-xl border border-border p-6">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-48 shrink-0">
                <a
                  href="https://drive.google.com/file/d/1Uy1bidKgkQG6i-Klx0UTD7BV6xGq8qcA/view?usp=sharing"
                  target="_blank"
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <a href="https://leetcode.com/medal/?showImg=0&id=8122549&isLevel=false" target="_blank" rel="noopener noreferrer" className="bg-card rounded-lg border border-border overflow-hidden hover:border-primary/50 transition-colors block">
              <img src="/achievements/leetcode-badge.png" alt="LeetCode 50-Day Badge" loading="lazy" className="w-full h-48 object-contain bg-secondary p-4" />
              <div className="p-4 text-center">
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                {runnerUpHighlights.map((item, index) => (
                  <a
                    ...
                    aria-label={`Open coding quiz achievement image ${index + 1}`}
                  >
        ...
        <div>
          ...
          <div className="space-y-4">
            {[
              ...
              {
                school: "PM Shri Kendriya Vidyalaya No.1, AFS, Agra",
              ...
              {
                school: "PM Shri Kendriya Vidyalaya No.2, AFS, Tezpur",
                loc: "Tezpur, Assam",
