...
const ContactSection = () => {
  ...
  const socials = [
    { url: "https://github.com/kumariroshani-890", icon: <Github size={22} />, hoverClass: "hover:text-primary hover:border-primary/50", isExternal: true },
    { url: "https://www.linkedin.com/in/roshani-kumari-0b9b9028a/", icon: <Linkedin size={22} />, hoverClass: "hover:text-primary hover:border-primary/50", isExternal: true },
    { url: "mailto:roshni1985upl@gmail.com", icon: <Mail size={22} />, hoverClass: "hover:text-primary hover:border-primary/50", isExternal: false },
    { url: "https://www.youtube.com/@DebugWithRoshani", icon: <Youtube size={22} />, hoverClass: "hover:text-red-500 hover:border-red-500/50", isExternal: true },
  ];
  ...
  return (
    <section id="contact" className="section-padding">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <p className="text-muted-foreground text-center mb-12 animate-slide-text-rl">
          Let's connect and discuss opportunities
        </p>

        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-card rounded-xl border border-border p-6 animate-slide-in-left">
            <h3 className="text-lg font-heading font-extrabold text-foreground mb-4">Connect With Me</h3>
          ...
          <div className="bg-card rounded-xl border border-border p-6 animate-slide-in-right">
            <h3 className="text-lg font-heading font-extrabold text-foreground mb-4">Send a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" className="w-full py-2.5 rounded-lg bg-primary text-primary-foreground font-bold text-sm hover:opacity-90 transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-primary/20">
                Send Message
              </button>
            </form>
          </div>
